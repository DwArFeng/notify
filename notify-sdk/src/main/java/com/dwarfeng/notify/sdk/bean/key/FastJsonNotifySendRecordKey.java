...
public class FastJsonNotifySendRecordKey implements Key {
    ...
    public static FastJsonNotifySendRecordKey of(NotifySendRecordKey notifySendRecordKey) {
        if (Objects.isNull(notifySendRecordKey)) {
            ...
            return new FastJsonNotifySendRecordKey(
    ...
    public FastJsonNotifySendRecordKey() {
    }

    public FastJsonNotifySendRecordKey(Long notifyHistoryId, String topicId, String userId) {
    ...
    public boolean equals(Object o) {
        ...
        FastJsonNotifySendRecordKey that = (FastJsonNotifySendRecordKey) o;
    ...
    public String toString() {
        return "FastJsonNotifySendRecordKey{" +

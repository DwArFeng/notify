...
public class NotifySettingDaoImpl implements NotifySettingDao {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<NotifySetting> lookup(String preset, Object[] objs) throws DaoException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<NotifySetting> lookup(String preset, Object[] objs, PagingInfo pagingInfo) throws DaoException {

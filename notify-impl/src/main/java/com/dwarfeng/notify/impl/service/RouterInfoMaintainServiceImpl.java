...
public class RouterInfoMaintainServiceImpl implements RouterInfoMaintainService {
    ...
    private final BatchCrudService<LongIdKey, RouterInfo> crudService;
    private final EntireLookupService<RouterInfo> entireLookupService;
    private final PresetLookupService<RouterInfo> presetLookupService;

    public RouterInfoMaintainServiceImpl(
            BatchCrudService<LongIdKey, RouterInfo> crudService,
            EntireLookupService<RouterInfo> entireLookupService,
            PresetLookupService<RouterInfo> presetLookupService
    ) {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public List<LongIdKey> batchInsertIfNotExists(@SkipRecord List<RouterInfo> elements) throws ServiceException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<RouterInfo> lookupAsList() throws ServiceException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<RouterInfo> lookupAsList(PagingInfo pagingInfo) throws ServiceException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public RouterInfo lookupFirst() throws ServiceException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<RouterInfo> lookupAsList(String preset, Object[] objs) throws ServiceException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<RouterInfo> lookupAsList(String preset, Object[] objs, PagingInfo pagingInfo) throws ServiceException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public RouterInfo lookupFirst(String preset, Object[] objs) throws ServiceException {

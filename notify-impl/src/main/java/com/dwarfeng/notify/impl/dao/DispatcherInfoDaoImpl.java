...
public class DispatcherInfoDaoImpl implements DispatcherInfoDao {
    ...
    private final BatchBaseDao<StringIdKey, DispatcherInfo> batchBaseDao;
    private final EntireLookupDao<DispatcherInfo> entireLookupDao;
    private final PresetLookupDao<DispatcherInfo> presetLookupDao;

    public DispatcherInfoDaoImpl(
            BatchBaseDao<StringIdKey, DispatcherInfo> batchBaseDao,
            EntireLookupDao<DispatcherInfo> entireLookupDao,
            PresetLookupDao<DispatcherInfo> presetLookupDao
    ) {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void update(DispatcherInfo element) throws DaoException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchUpdate(@SkipRecord List<DispatcherInfo> elements) throws DaoException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<DispatcherInfo> lookup() throws DaoException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<DispatcherInfo> lookup(PagingInfo pagingInfo) throws DaoException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<DispatcherInfo> lookup(String preset, Object[] objs) throws DaoException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<DispatcherInfo> lookup(String preset, Object[] objs, PagingInfo pagingInfo) throws DaoException {

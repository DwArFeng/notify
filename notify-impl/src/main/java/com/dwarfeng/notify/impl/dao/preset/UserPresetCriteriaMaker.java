...
@Component
public class UserPresetCriteriaMaker implements PresetCriteriaMaker<HibernateUser> {

    @Override
    public void makeCriteria(
            CriteriaBuilder criteriaBuilder, CriteriaQuery<?> criteriaQuery, Root<HibernateUser> root,
        ...
        switch (s) {
            case UserMaintainService.ID_LIKE:
                ...
                break;
            case UserMaintainService.ENABLED:

...
@Entity
@IdClass(HibernatePreferenceKey.class)
@Table(name = "tbl_preference")
public class HibernatePreference implements Bean {

    private static final long serialVersionUID = -8653956624836137817L;
    ...
    public HibernatePreference() {
    }

    // -----------------------------------------------------------映射用属性区-----------------------------------------------------------
    public HibernatePreferenceKey getKey() {
        return new HibernatePreferenceKey(notifySettingId, topicId, userId, preferenceId);
    }

    public void setKey(HibernatePreferenceKey key) {

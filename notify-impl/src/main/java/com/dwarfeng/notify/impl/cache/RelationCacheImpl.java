...
public class RelationCacheImpl implements RelationCache {
    ...
    private final RedisBatchBaseCache<RelationKey, Relation, FastJsonRelation>
            relationBatchBaseDelegate;

    public RelationCacheImpl(
            RedisBatchBaseCache<RelationKey, Relation, FastJsonRelation>
                    relationBatchBaseDelegate
    ) {

 ...
 * @since 1.3.0
 */
public class HibernateNotifySendRecordKey implements Key {

    private static final long serialVersionUID = -7100777531882484011L;
    
    private Long notifyHistoryId;
    private String topicId;
    private String userId;

    public HibernateNotifySendRecordKey() {
    }

    public HibernateNotifySendRecordKey(Long notifyHistoryId, String topicId, String userId) {
    ...
    public boolean equals(Object o) {
        ...
        HibernateNotifySendRecordKey that = (HibernateNotifySendRecordKey) o;
    ...
    public String toString() {
        return "HibernateNotifySendRecordKey{" +

...
public class ResetCommand extends CliCommand {
    ...
    private static final String CMD_LINE_SYNTAX_RESET_ROUTE = IDENTITY + " " +
            CommandUtil.concatOptionPrefix(COMMAND_OPTION_RESET_ROUTE);
    private static final String CMD_LINE_SYNTAX_RESET_DISPATCH = IDENTITY + " " +
            CommandUtil.concatOptionPrefix(COMMAND_OPTION_RESET_DISPATCH);
    private static final String CMD_LINE_SYNTAX_RESET_SEND = IDENTITY + " " +
            CommandUtil.concatOptionPrefix(COMMAND_OPTION_RESET_SEND);
    ...
    private static final String[] CMD_LINE_ARRAY = new String[]{
            ...
            CMD_LINE_SYNTAX_RESET_ROUTE,
            CMD_LINE_SYNTAX_RESET_DISPATCH,
            CMD_LINE_SYNTAX_RESET_SEND
    };
    ...
    protected List<Option> buildOptions() {
        ...
        list.add(Option.builder().longOpt(COMMAND_OPTION_RESET_ROUTE).desc("执行路由重置操作").build());
        list.add(Option.builder().longOpt(COMMAND_OPTION_RESET_DISPATCH).desc("执行调度重置操作").build());
        list.add(Option.builder().longOpt(COMMAND_OPTION_RESET_SEND).desc("执行发送重置操作").build());
        return list;
    }

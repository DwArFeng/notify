...
public class NotifyInfoRecordCacheImpl implements NotifyInfoRecordCache {
    ...
    public void push(NotifyInfoRecord value, long timeout) throws CacheException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public void batchPush(@SkipRecord List<NotifyInfoRecord> entities, long timeout) throws CacheException {

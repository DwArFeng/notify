...
public class SenderSupportMaintainServiceImpl implements SenderSupportMaintainService {
    ...
    private final BatchCrudService<StringIdKey, SenderSupport> crudService;
    private final EntireLookupService<SenderSupport> entireLookupService;
    private final PresetLookupService<SenderSupport> presetLookupService;

    public SenderSupportMaintainServiceImpl(
            BatchCrudService<StringIdKey, SenderSupport> crudService,
            EntireLookupService<SenderSupport> entireLookupService,
            PresetLookupService<SenderSupport> presetLookupService
    ) {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", rollbackFor = Exception.class)
    public List<StringIdKey> batchInsertIfNotExists(@SkipRecord List<SenderSupport> elements) throws ServiceException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<SenderSupport> lookupAsList() throws ServiceException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<SenderSupport> lookupAsList(PagingInfo pagingInfo) throws ServiceException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public SenderSupport lookupFirst() throws ServiceException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public PagedData<SenderSupport> lookup(String preset, Object[] objs, PagingInfo pagingInfo)
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<SenderSupport> lookupAsList(String preset, Object[] objs) throws ServiceException {
    ...
    @SkipRecord
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public List<SenderSupport> lookupAsList(String preset, Object[] objs, PagingInfo pagingInfo)
            throws ServiceException {
    ...
    @BehaviorAnalyse
    @Transactional(transactionManager = "hibernateTransactionManager", readOnly = true, rollbackFor = Exception.class)
    public SenderSupport lookupFirst(String preset, Object[] objs) throws ServiceException {

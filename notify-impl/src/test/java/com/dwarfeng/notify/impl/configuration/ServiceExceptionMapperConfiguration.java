...
public class ServiceExceptionMapperConfiguration {
    ...
    public MapServiceExceptionMapper mapServiceExceptionMapper() {
        Map<Class<? extends Exception>, java.util.function.Supplier<ServiceException.Code>> des = ServiceExceptionHelper.putDefaultDestination(null);
        ...
        des = com.dwarfeng.notify.sdk.exception.ServiceExceptionHelper.putDefaultDestination(des);
        return new MapServiceExceptionMapper(des, com.dwarfeng.subgrade.basic.sdk.exception.ServiceExceptionCodeSuppliers.UNDEFINED);
    }
}

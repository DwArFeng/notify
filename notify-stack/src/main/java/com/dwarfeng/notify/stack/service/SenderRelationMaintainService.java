 ...
 * @since 1.1.0
 */
public interface SenderRelationMaintainService extends BatchCrudService<SenderRelationKey, SenderRelation>,
        EntireLookupService<SenderRelation>, PresetLookupService<SenderRelation> {

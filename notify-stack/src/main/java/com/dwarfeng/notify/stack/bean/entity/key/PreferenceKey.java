 ...
 * @since 1.1.0
 */
public class PreferenceKey implements Key {

    private static final long serialVersionUID = 7084780132516210897L;
    ...
    public PreferenceKey(Long notifySettingId, String topicId, String userId, String preferenceId) {
